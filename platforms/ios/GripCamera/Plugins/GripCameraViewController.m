...
- (UIView*)createOverlay {
    ...
    UIImageView *topLeftGuide = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"guide_top_left.png"]];
    topLeftGuide.frame = CGRectMake(kHorizontalInset, kVerticalInset, kGuideWidth, kGuideHeight);
    [overlay addSubview:topLeftGuide];
    
    UIImageView *topRightGuide = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"guide_top_right.png"]];
    ...
    UIImageView *bottomLeftGuide = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"guide_bottom_left.png"]];
    ...
    UIImageView *bottomRightGuide = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"guide_bottom_right.png"]];
...
- (void)enableButtonIfCameraIsInFocus {
    if (_rearCamera.adjustingFocus) {
        ...
        [_captureButton setImage:[UIImage imageNamed:@"camera_disabled_icon.png"] forState:UIControlStateNormal];
    } else {
        _captureButton.enabled = YES;
        [_captureButton setImage:[UIImage imageNamed:@"camera_enabled_icon.png"] forState:UIControlStateNormal];
    }
}
